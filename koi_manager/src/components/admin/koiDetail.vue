     ...
     <div class="add-exp-form">
        <el-form :model="form" style="width:95%;">
          ...
          <el-form-item label="参考资料" :label-width="formLabelWidth">
           ...
           <el-form-item label="申请人" :label-width="formLabelWidth"  v-show="userName !== ''">
             <el-input v-model="userName" placeholder="请输入申请人" type="input" auto-complete="off" :disabled="true"></el-input>
           </el-form-item>

           <el-form-item label="申请理由" :label-width="formLabelWidth" v-show="description !== ''">
            <el-input v-model="description"  placeholder="请输入申请理由" :autosize="true" type="textarea" auto-complete="off" :disabled="true"></el-input>
           </el-form-item>
...
<script>
   ...
   export default {
     ...
     props:['formData','description','userName'],
     methods:{
        setWindow() {
